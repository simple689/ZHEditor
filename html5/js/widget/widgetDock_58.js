...
widgetDockPanel.prototype._$03 = function (mainPattern, _$mX, pt, _$nz, _$dk, _$oQ, _$de) {
    ...
    if (_$mX._$it) {
        ...
        mainPattern._$5r(mainPattern._$he, rcPanel);
...
_$6R.prototype._$w = function (floatPanel, pt) {
    var rc = new WidgetDockRect();
    var _$8m = false;
...
_$6R.prototype._$2b = function (pt, _$ny) {
    var _$pO = _$kI;
    var _$8x = null;
    var pf;
    while (true) {
...
_$6R.prototype._$03 = function (mainPattern, _$mX, pt, _$nz, _$dk, _$oQ, _$de) {
    _$de[0] = 0;
    _$oQ[0] = null;
    var rcPanel = new WidgetDockRect();
...
_$6R.prototype._$2l = function (floatPanelController, floatPanel) {
    var _$eq = 0;
    var _$er = -1;
    var _$pO = this._$kI;
    while (_$pO != null) {
...
_$6R.prototype._$7 = function (mainPattern, floatPanel) {
    ...
    _$ol = floatPanelController._panelList[_$er];
    ...
    if (_$8D[0] || (_$9t && ((this.rect.right - this.rect.left) < (_$gE[0] + _$eI))) || (!_$9t && ((this.rect.bottom - this.rect.top) < (_$gE[0] + _$eI)))) {
        ...
        if ((_$9t && ((this.rect.right - this.rect.left) >= _$eP)) || (!_$9t && ((this.rect.bottom - this.rect.top) >= _$eP))) {
            ...
            for (i = 0; i < _$e1; i++) {
                _$ol = floatPanelController._panelList[i];
            ...
            if (_$er > 0) {
                _$ol = floatPanelController._panelList[_$er - 1];
...
_$6R.prototype._$g = function (_$8h, _$cP, _$8c, pt) {
...
_$6R.prototype._$5z = function (floatPanel, pt, _$q5) {
...
_$6R.prototype._$0B = function (floatPanel, pt, _$87) {
    var _$eT = new Array(1);
    if (_$87) {
        WidgetDockPatternBase._$6a(_$je, pt);
    }
...
_$6R.prototype._$63 = function (mainPattern, layout, _$mS) {
};
    ...
    for (var i = 0; i < _$e1; i++) {
        ...
        if (this._$hj == null) {
            if (_$pE._titleElement != null) {
                ...
                _$pE._titleElement.innerHTML = _$pE.title;
            }
            continue;
        }
        var size = new WidgetDockSize();
        WidgetDockElementController.getOffsetSize(size, _$ba, _$pE.title, this._$hj);
        if (_$cD == EnumPatternPositionType.Top || _$cD == EnumPatternPositionType.Bottom) {
            rc.left = _$pE._$cv;
            rc.right = _$pE._$cE;
            ...
            this._$hj.fillText(_$pE.title, rc.left, (rc.bottom - rc.top) / 2 + rc.top + 4);
        } else {
            this._$hj.save();
            this._$hj._$s1 = 'ButtonShadow';
...
_$58.prototype._$03 = function (mainPattern, _$mX, pt, _$nz, _$dk, _$oQ, _$de) {
    _$de[0] = 0;
    _$oQ[0] = null;
    var rcPanel = new WidgetDockRect();
...
_$58.prototype._$8 = function (floatPanel) {
    ...
    tab._titleElement._$4A = this;
    tab._floatPanel = floatPanel;
    this._$hU.addFloatPanel(tab);
    this._$5A();
    this.refresh();
};
...
_$58.prototype.getSize = function () {

...
WidgetDockFloatPanel.prototype.setTitle = function (title) {
    ...
    if (_$kA != null && _$kA._$o5 != null && _$kA._$o5._tabList.length > 1) {
...
WidgetDockFloatPanel.prototype._$rB = function (sch) {
    ...
    if (sch) {
        ...
        if (!this._$fT()) {
            if (this._$kA == null || this._$kA._$o5 == null || this._$kA._$o5._tabList.length <= 1) return;
...
WidgetDockFloatPanel.prototype._$s8 = function () {
    ...
    if (this._pattern != null) {
        var _$aQ = null;
        if (WidgetDockFloatPanel._$jy == WidgetDockFloatPanel._$0V && this._$kA._$o5 != null && (this._$kA._$o5._tabList.length > 1)) {
...
WidgetDockFloatPanel.prototype._$4i = function (pt) {
    ...
    if (this._$lN[0] <= 7) {
        ...
        if ((WidgetDockFloatPanel._$jy == WidgetDockFloatPanel._$0V) && (this._$kA._$o5 != null) && this._$kA._$o5._tabList.length > 1) {
            ...
            if (WidgetDockFloatPanel._$jy != WidgetDockFloatPanel._$0W) {
                ...
                var pbk = (this._pattern._patternPositionList[0]._panelTabList[0])._$kI;
                pbk._$2Q(_$7F);
                var ic = _$7F.getPanelNum();
                for (i = 0; i < ic; i++) {
                    if (_$7F._panelTabList[i]._$1k(this._$lf._$kM, this._$lN[0])) break;
                }
                if (i == ic) {
                    this._$lN[0] = 8;
                }
    ...
    if ((this._$lN[0] == 0xff) || (this._$lN[0] > 7)) {
        ...
        if (this._$lf._$iM && this._$lf._$ka >= 0 && this._$lf._$kM != null) {
            var _$e1 = this._$lf._$kM._patternPositionList[this._$lN[0]].getPanelNum();
            var _$g5 = this._$lf._$ka - 1;
            if (_$g5 < _$e1) {
                var _$pY = null;
                for (var k = 0; k <= _$g5; k++) {
                    _$pY = this._$lf._$kM._patternPositionList[this._$lN[0]]._panelTabList[_$g5 - k];
                    if (_$pY._$iX) break;
                    _$pY = null;
                }
...
WidgetDockFloatPanel.prototype._$2Q = function (_$mY, mainPattern, _$85, _$7O) {
    ...
    for (var i = 0; i < com.length; i++) {
        if (com[i] instanceof WidgetDockFloatPanel) {
            _$sx = com[i];
            if (!_$sx._$kA._$8y) {
                if (_$sx._$kA._$o5 != null && _$sx._$kA._$o5._tabList.length >= 1) {
                    var _$e1 = _$sx._$kA._$o5._tabList.length;
                    var j;
                    for (j = 0; j < _$e1; j++) {
                        _$mY._$5E(_$sx._$kA._$o5._tabList[j]._floatPanel);
                        mainPattern.Add(_$sx._$kA._$o5._tabList[j]._floatPanel);
                        _$7F.addFloatPanel(_$sx._$kA._$o5._tabList[j]._floatPanel);
                    }
                    _$sx._$kA._$o5 = null;
                } else {
                    if (com[i]._$fT()) {
    ...
    _$mY._patternPositionList[0]._panelTabList[0]._$iX = false;
    _$mY._$01();
    return _$7F;
};
WidgetDockFloatPanel.prototype._$33 = function (_$mY, mainPattern) {
    ...
    var _$oE = new _$F();
    var _$oK = _$mY._patternPositionList[0]._panelTabList[0]._$kI;
    _$oE._$5J(_$oK);
    var _$7F;
    ...
    var i;
    for (i = 0; i < _$e1; i++) {
        if (_$7F._panelTabList[i] != this) _$7F._panelTabList[i]._$qz(-1);
    }
    return _$oE;
};
    ...
    if ((this._$lf._$j1 != 0xff) && (this._$lf._$j1 < 4)) {
        ...
        if (WidgetDockFloatPanel._$jy == WidgetDockFloatPanel._$0V && this._$kA._$o5 != null && this._$kA._$o5._tabList.length > 1) {
            ...
            if (WidgetDockFloatPanel._$jy != WidgetDockFloatPanel._$0W) {
                ...
                var _$f8 = 0;
                for (i = 0; i < ic; i++) {
                    if (!_$7F._panelTabList[i]._$1k(this._$lf._$kM, this._$lf._$j1)) {
                        _$oX[_$en] = _$7F._panelTabList[i];
                        _$9q[_$en] = _$oX[_$en]._$fT();
                        _$en++;
                    } else {
                        _$aQ[_$f8] = _$7F._panelTabList[i];
                        _$f8++;
                    }
                }
                if (_$en == ic) {
        ...
        if (this._$lf._$ky == null) {
            if (WidgetDockFloatPanel._$jy != WidgetDockFloatPanel._$0W) {
                if (_$nZ != null) {
                    ...
                    for (i = 0; i < _$f8; i++) {
                        if (_$aQ[i] != this) {
                            ...
                            if (_$aQ[i]._pattern != null && _$aQ[i]._pattern._isMain) _$aQ[i]._$be(_$aQ[i]._patternPositionType); else _$aQ[i]._$be(EnumPatternPositionType.Center);
                        }
                    }
                }
                ...
                for (k = 0; k < _$f8; k++) {
                    if (_$aQ[k] != this) {
                        if (_$aQ[k]._pattern != null && _$aQ[k]._pattern._isMain) _$aQ[k]._$be(_$aQ[k]._patternPositionType); else _$aQ[k]._$be(EnumPatternPositionType.Center);
                    }
                }
            }
        } else {
        ...
        if (_$nZ != null) {
            if (this._$lf._$kM != null && this._$lf._$kM._isMain) _$nZ._$be(this._$lf._$j1); else _$nZ._$be(EnumPatternPositionType.Center);
            _$nZ._$qz(-1);
...
WidgetDockFloatPanel.prototype._$qz = function (_$9d) {
    ...
    if (this._$jm >= WidgetDockFloatPanel._$0) {
        ...
        var _$8o = false;
        if (this._$kA != null && this._$kA._$o5 != null && this._$kA._$o5._tabList.length > 1 && this._$kA._$o5._floatPanel == this) {
            _$8o = true;
        }
        if (!_$8o) {
...
WidgetDockFloatPanel.prototype.initLayout = function (left, top, width, height, type) {
    ...
    for (var i = 0; i < panelNum; i++) {
        var panel = WidgetDockFloatPanel._floatPanelController._panelTabList[i];
...
WidgetDockFloatPanel.prototype._$bh = function () {
    ...
    if (this._pattern != null && this._pattern._isMain) this._$6F();
    return true;
};
...
WidgetDockFloatPanel.prototype._$0C = function () {
    ...
    this._pinType = EnumPinType.Hide;
    var panel = null;
    var _$e1 = this._pattern._patternPositionList[_$9u].getPanelNum();
    if (_$e1 > 0 && this._$jr >= 0 && this._$jr < _$e1) {
        panel = this._pattern._patternPositionList[_$9u]._panelTabList[this._$jr];
    }
    var ih, iw;
    if (panel != null) {
...
WidgetDockFloatPanel.prototype._$Y = function (mainPattern, _$cD, _$dg) {
    if (mainPattern != null && mainPattern._isMain && _$dg >= 0 && _$dg != 0xffffffff) {
        var panel = mainPattern._patternPositionList[_$cD]._panelTabList[_$dg];
        var _$eG, _$fC;
        var _$fq, _$fr;
        _$fq = -1;
        _$fr = -1;
...
WidgetDockWindow.prototype._$0g = function () {
    ...
    _$e1 = floatPanelController.getPanelNum();
    var i;
    for (i = _$e1 - 1; i >= 0; i--) {
        if (floatPanelController._panelTabList[i] != this) {
            floatPanelController._panelTabList[i]._$0g();
        }
    }
...
WidgetDockWindow.prototype.loadStatesFromLayoutController = function (layoutController) {
    ...
    for (var i = 0; i < 4; i++) {
        patternPositionPanelNumList[i] = this._patternMain._patternPositionList[i].getPanelNum();
    }
    ...
    if (WidgetDockFloatPanel._floatPanelController != null) {
        ...
        for (var j = 0; j < panelNum; j++) {
            var panel = WidgetDockFloatPanel._floatPanelController._panelTabList[j];
            if (panel._isInitLayout) floatPanelController.addFloatPanel(WidgetDockFloatPanel._floatPanelController._panelTabList[j]);
        }
    }
    ...
    for (var i = 0; i < ino; i++) {
        var _$si = floatPanelController._panelTabList[i]._$c3();
        _$e1 = _$aj.getPanelNum();
        var j;
        for (j = 0; j < _$e1; j++) {
            var _$fY = _$aj._panelTabList[j]._patternPositionList[0].getPanelNum();
            if (_$fY == 1) {
                var mi = _$aj._panelTabList[j];
                var _$nT = this._patternMain._$1N(_$si, mi._patternPositionList[0]._panelTabList[0]._$kI);
                if (_$nT != null) {
                    _$aj._panelTabList[j]._$53(_$nT, null, _$si, 0, 0);
                    _$fY = _$aj._panelTabList[j]._patternPositionList[0].getPanelNum();
                    if (_$fY == 0) {
                        _$oh = this._$kL;
                        _$e1 = _$oh.length;
                        var n;
                        for (n = 0; n < _$e1; n++) {
                            if (_$oh[n] == _$aj._panelTabList[j]) {
                                _$oh.split(n, 1);
                                break;
                            }
                        }
...
WidgetDockWindow.prototype.createLayout = function (layout) {
    ...
    for (var i = 0; i < 4; i++) {
        ...
        var panelNum = this._patternMain._patternPositionList[i].getPanelNum();
        var panel;
        var index = 0;
        for (var j = 0; j < panelNum; j++) {
            panel = this._patternMain._patternPositionList[i]._panelTabList[j];
    ...
    var panelNum;
    for (var i = 0; i < _$e1; i++) {
        panelNum = this._$kL[i]._patternPositionList[0].getPanelNum();
        if (panelNum == 1) {
            ino++;
        }
    }
    ...
    for (var i = 0; i < _$e1; i++) {
        ...
        if (panelNum == 1) {
            ...
            layout.addContent(rcWindow.right);
            layout.addContent(rcWindow.bottom);
            panel = _$og._patternPositionList[0]._panelTabList[0];
...
WidgetDockWindow.prototype._$1O = function (floatPanel, title, _$nO, _$dA, _$dC, _$nP, _$cX) {
    ...
    for (var i = 0; i < ino; i++) {
        _$og = this._$kL[i];
        _$e1 = _$og._patternPositionList[0].getPanelNum();
        if (_$e1 == 1) {
            var _$ps = _$og._patternPositionList[0]._panelTabList[0];

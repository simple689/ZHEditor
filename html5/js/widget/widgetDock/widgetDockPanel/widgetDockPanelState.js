...
WidgetDockPanelState.prototype._$2b = function (pt, _$ny) {
    ...
    var pf;
    while (true) {
        if (_$pO._m$F_1 == null && _$pO._m$F_2 == null) {
...
WidgetDockPanelState.prototype._$03 = function (mainPattern, _$mX, pt, _$nz, _$dk, _$oQ, _$de) {
    ...
    if (_$9z != 0xff) {
        if (this.m$N._patternPositionType == EnumPatternPositionType.Left || this.m$N._patternPositionType == EnumPatternPositionType.Right) {
            _$nz.y = _rect.bottom - _rect.top;
        } else {
            _$nz.x = _rect.right - _rect.left;
        }
    }
    return _$9z;
};
WidgetDockPanelState.prototype._$6v = function (patternBase, _$9c, _$cA) {
    this._$6q(this._rect);
    this.refresh();
    ...
    var _$rK;
    if (_$9t) {
        _$rK = ((this._rect.right - this._rect.left) - _$gE[0]);
    } else {
        _$rK = ((this._rect.bottom - this._rect.top) - _$gE[0]);
    }
    if (_$8D[0] || this._$js > 1) {
        this._$6w(_$8j, _$rK, _$cA);
        return;
    }
    if ((_$9t && (_$gE[0] > (this._rect.right - this._rect.left))) || ((!_$9t) && (_$gE[0] > (this._rect.bottom - this._rect.top)))) {
        this._$6w(_$8j, _$rK, _$cA);
        return;
    }
    for (var i = 0; i < _$e1; i++) {
        m$57 = _$8j._list[i];
        m$57._$nQ.getRect(_$q7);
        if (_$9t && (_$q7.right > (this._rect.right - this._rect.left))) {
            _$eq[0] = i;
            _$eR[0] = _$q7.left;
            break;
        } else if (!_$9t && (_$q7.bottom > (this._rect.bottom - this._rect.top))) {
            _$eq[0] = i;
            _$eR[0] = _$q7.top;
            break;
        }
    ...
    if (_$eq[0] >= 0) {
        ...
        if (_$9t) {
            rc.top = 0;
            rc.bottom = _$8j._list[_$eq[0]].size.y;
            _$fn = _$eR[0] + _$2H(_$8j, _$eq[0], _$e1, false) - (this._rect.right - this._rect.left);
        } else {
            rc.left = 0;
            rc.right = _$8j._list[_$eq[0]].size.x;
            _$fn = _$eR[0] + _$2H(_$8j, _$eq[0], _$e1, false) - (this._rect.bottom - this._rect.top);
        }
        if (_$fn > _$fx) _$eR[0] -= _$fx; else _$eR[0] -= _$fn;
        if (_$9t) rc.right = _$eR[0]; else rc.bottom = _$eR[0];
        for (var i = 0; i < _$eq[0]; i++) {
            m$57 = _$8j._list[_$eq[0] - 1 - i];
            m$57._$nQ.getRect(_$q7);
            if (_$9t) {
                if (_$q7.right < rc.right) break;
                rc.left = rc.right - m$57.size.x;
                m$57._$nQ.resize(rc);
                rc.right = rc.left;
            } else {
                if (_$q7.bottom < rc.bottom) break;
                rc.top = rc.bottom - m$57.size.y;
                m$57._$nQ.resize(rc);
                rc.bottom = rc.top;
            }
        }
        ...
        for (var i = _$eq[0]; i < _$e1; i++) {
            m$57 = _$8j._list[i];
            if (_$9t) {
                rc.right = rc.left + m$57.size.x;
                m$57._$nQ.resize(rc);
                rc.left = rc.right;
            } else {
                rc.bottom = rc.top + m$57.size.y;
                m$57._$nQ.resize(rc);
                rc.top = rc.bottom;
            }
        }
...
WidgetDockPanelState.prototype._$11 = function (_$mZ) {
    if (_$mZ._m$FParent == null) {
        _$mZ._floatPanel = null;
    } else {
        var _$pb;
        if (_$mZ == _$mZ._m$FParent._m$F_1) {
            _$pb = _$mZ._m$FParent._m$F_2;
            _$mZ._m$FParent._m$F_1 = _$pb._m$F_1;
            _$mZ._m$FParent._m$F_2 = _$pb._m$F_2;
            if (_$pb._m$F_1 != null) {
                _$pb._m$F_1._m$FParent = _$mZ._m$FParent;
            }
            if (_$pb._m$F_2 != null) {
                _$pb._m$F_2._m$FParent = _$mZ._m$FParent;
            }
            _$mZ._m$FParent._floatPanel = _$pb._floatPanel;
            _$mZ._m$FParent._$8y = _$pb._$8y;
            if (_$pb._floatPanel != null) {
                if (_$pb._floatPanel._m$F == _$pb) {
                    _$pb._floatPanel._m$F = _$mZ._m$FParent;
                }
                if (_$pb._floatPanel._$l6 == _$pb) {
                    _$pb._floatPanel._$l6 = _$mZ._m$FParent;
                }
            }
        } else {
            if (_$mZ._m$FParent._m$FParent == null) {
                _$pb = _$mZ._m$FParent._m$F_1;
                _$mZ._m$FParent._m$F_1 = _$mZ._m$FParent._m$F_2 = null;
                _$mZ._m$FParent._floatPanel = _$pb._floatPanel;
                _$mZ._m$FParent._$8y = _$pb._$8y;
                if (_$pb._floatPanel != null) {
                    if (_$pb._floatPanel._m$F == _$pb) {
                ...
                _$pb = _$mZ._m$FParent;
                _$pb._m$FParent._m$F_2 = _$pb._m$F_1;
                _$pb._m$F_1._m$FParent = _$pb._m$FParent;
            }
        }
        _$pb._floatPanel = null;
        _$pb._m$F_1 = _$pb._m$F_2 = null;
    }
};
...
WidgetDockPanelState.prototype._$53 = function (_m$F) {
    _$11(_m$F);
    if (_m$F != _m$F) {
        return false;
    } else if (this._m$F._m$F_2 == null && this._m$F._m$F_2 == null && this._m$F._floatPanel == null) {
        return true;
    }
    return false;
};
WidgetDockPanelState.prototype._$f = function (mainPattern, _m$F, pRC) {
    if (this._m$F == _m$F) return true;
    var _$pN = _m$F;
    var _$8g = true;
    while (_$pN != null) {
        if (_$pN._m$F_1 == null && _$pN._m$F_2 == null && !_$pN._$8y) {
            _$8g = false;
            break;
        }
        if (_$pN._m$F_1 != null && _$pN._m$F_1._floatPanel != null && !_$pN._m$F_1._$8y) {
            _$8g = false;
            break;
        }
        _$pN = _$pN._m$F_2;
    ...
    if (!_$8g) {
        ...
        var _$e1, _$er;
        var _$8j = new WidgetDockListController();
        _$er = _$2l(_$8j, _m$F._floatPanel);
        _$e1 = _$8j.getSize();
        _m$F._$8y = true;
        var _positionType_1;
        if (this.m$N != null) _positionType_1 = this.m$N._patternPositionType; else _positionType_1 = _m$F._floatPanel.m$6P._$j1;
        var _$9t = true;
        if (_positionType_1 == EnumPatternPositionType.Right || _positionType_1 == EnumPatternPositionType.Left) _$9t = false;
        var _$8D = new Array(1);
        var _$gE = new Array(1);
        var iid = new Array(1);
        var imo = new Array(1);
        ...
        if ((_$9t && (_$ow.size.y >= (_rect.bottom - _rect.top))) || (!_$9t && (_$ow.size.x >= (_rect.right - _rect.left)))) {
            if (_$9t && (_$g2 < _$ow.size.y)) {
                _$fW[0] = _$g2 - _$ow.size.y;
            } else if (!_$9t && (_$g2 < _$ow.size.x)) {
                _$fW[0] = _$g2 - _$ow.size.x;
            }
        }
        var _$eL = _$2H(_$8j, 0, _$8j.getSize(), false);
        if ((_$9t && (_$eL <= (this._rect.right - this._rect.left))) || (!_$9t && (_$eL <= (this._rect.bottom - this._rect.top)))) {
            var j;
            for (j = 0; j < _$8j.getSize(); j++) {
                var m$57 = _$8j._list[j];
                var _$ov = m$57._$nQ;
                _$ov._$5S();
            }
        ...
        if (_$8D[0]) {
            ...
            if ((_$9t && (_$eP <= (this._rect.right - this._rect.left))) || (!_$9t && (_$eP <= (this._rect.bottom - this._rect.top)))) {
                ...
                for (k = 0; k < _$e1; k++) {
                    m$57 = _$8j._list[k];
                    if (_$9t) {
                        _$gu += m$57._$nQ.getWidth();
                    } else {
                        _$gu += m$57._$nQ.getHeight();
                    }
                }
                var _$rK;
                if (_$9t) _$rK = ((this._rect.right - this._rect.left) - _$gu); else _$rK = ((this._rect.bottom - this._rect.top) - _$gu);
                _$6w(_$8j, _$rK, _$fW);
                if (_$fW[0] != 0) {
...
WidgetDockPanelState.prototype._$2H = function (floatPanelController, left, right, _$7N) {
    ...
    for (i = left; i < right; i++) {
        ...
        var _positionType_1;
        if (this.m$N != null) _positionType_1 = this.m$N._patternPositionType; else _positionType_1 = _$os._$nQ.m$6P._$j1;
        if (_positionType_1 == EnumPatternPositionType.Top || _positionType_1 == EnumPatternPositionType.Bottom) {
            if (!_$7N) _$fe += _$os.size.x; else _$fe += _$os._$nQ.getWidth();
        } else {
            if (!_$7N) _$fe += _$os.size.y; else _$fe += _$os._$nQ.getHeight();
        }
    }
    return _$fe;
};
    ...
    while (_$pO != null) {
        if (_$pO._m$F_1 == null && _$pO._m$F_2 == null) {
            if (!_$pO._$8y && _$pO._floatPanel != null) {
                var m$57 = new _$44();
                var bts = _$pO._floatPanel.m$6P._$j1;
                if (this.m$N != null) _$pO._floatPanel.m$6P._$j1 = this.m$N._patternPositionType;
                _$pO._floatPanel._$2w(m$57.size, 0, null, false);
                _$pO._floatPanel.m$6P._$j1 = bts;
                m$57._$nQ = _$pO._floatPanel;
                floatPanelController.add(m$57);
            ...
            if (_$pO._m$F_1 != null) {
                ...
                if (pf._floatPanel != null && !pf._$8y) {
                    ...
                    var m$57 = new _$44();
                    var bts = pf._floatPanel.m$6P._$j1;
                    if (this.m$N != null) {
                        pf._floatPanel.m$6P._$j1 = this.m$N._patternPositionType;
                    }
                    pf._floatPanel._$2w(m$57.size, 0, null, false);
                    pf._floatPanel.m$6P._$j1 = bts;
                    m$57._$nQ = pf._floatPanel;
                    floatPanelController.add(m$57);
                    _$eq++;
                }
            }
...
WidgetDockPanelState.prototype._$7 = function (mainPattern, floatPanel) {
    ...
    m$57 = floatPanelController._list[_$er];
    floatPanelController.delete(_$er);
    this._$04(_$9t, floatPanelController, _$8D, _$gE, _$eq, _$eR);
    floatPanelController.insert(m$57, _$er);
    var _$eI = 0;
    _$eI = floatPanel._$2o(_$9t);
    if (_$8D[0] || (_$9t && ((this._rect.right - this._rect.left) < (_$gE[0] + _$eI))) || (!_$9t && ((this._rect.bottom - this._rect.top) < (_$gE[0] + _$eI)))) {
        var _$eP = this._$2s(floatPanelController, 0, floatPanelController.getSize());
        if ((_$9t && ((this._rect.right - this._rect.left) >= _$eP)) || (!_$9t && ((this._rect.bottom - this._rect.top) >= _$eP))) {
            var _$mI = new WidgetDockListController();
            this._$2t(floatPanelController, 0, _$mI);
            for (i = 0; i < _$e1; i++) {
                m$57 = floatPanelController._list[i];
                if (m$57._$nQ != floatPanel) {
                    m$57.size.x = m$57._$nQ.getWidth();
                    m$57.size.y = m$57._$nQ.getHeight();
                    if (_$9t) {
                        m$57._$du = m$57._$nQ.getWidth();
                    } else {
                        m$57._$du = m$57._$nQ.getHeight();
                    }
                } else {
            ...
            if (_$er > 0) {
                m$57 = floatPanelController._list[_$er - 1];
                var _$qo = new WidgetDockRect();
                m$57._$nQ.getRect(_$qo);
                var _$eO = 0;
                _$eO = m$57._$nQ._$2r();
                if (_$9t && (_$qo.right >= pt.x)) {
                    if ((pt.x - _$qo.left) > _$eO) {
                        m$57._$nQ._$k6 = pt.x - _$qo.left;
                    } else {
                        m$57._$nQ._$k6 = _$eO;
                    }
                    m$57._$du = m$57._$nQ._$k6;
                } else if (!_$9t && (_$qo.bottom >= pt.y)) {
                    if ((pt.y - _$qo.top) > _$eO) {
                        m$57._$nQ._$k6 = pt.y - _$qo.top;
                    } else {
                        m$57._$nQ._$k6 = _$eO;
                    }
                    m$57._$du = m$57._$nQ._$k6;
            ...
            if (_$er < (_$e1 - 1)) {
                m$57 = floatPanelController._list[_$er + 1];
                var _$qo = new WidgetDockRect();
                m$57.bar.getRect(_$qo);
                var _$eO = 0;
                _$eO = m$57._$nQ._$2r();
                if (_$9t && (_$qo.left <= pt.x)) {
                    if ((_$qo.right - pt.x) > _$eO) {
                        m$57._$nQ._$k6 = _$qo.right - pt.x;
                    } else {
                        m$57._$nQ._$k6 = _$eO;
                    }
                    m$57._$du = m$57._$nQ._$k6;
                    ...
                    if ((_$qo.bottom - pt.y) > _$eO) {
                        m$57._$nQ._$k6 = _$qo.bottom - pt.y;
                    } else {
                        m$57._$nQ._$k6 = _$eO;
                    }
                    m$57._$du = m$57._$nQ._$k6;
            ...
            var _$gD = this._rect.right - this._rect.left;
            if (!_$9t) _$gD = this._rect.bottom - this._rect.top;
            var _$rK = (_$gD - _$dN);
...
WidgetDockPanelState.prototype.setVisible = function (sch) {
    if (this._panelStateElement != null) {
...
WidgetDockPanelState.prototype._$0m = function (_$9t, iwh) {
    var _$e7 = 0;
    if (!_$9t && iwh != (this._rect.right - this._rect.left)) {
        _$e7 = iwh - (this._rect.right - this._rect.left);
        if (this.m$N._patternPositionType == EnumPatternPositionType.Right) this._rect.left -= _$e7;
        this._rect.right = this._rect.left + iwh;
    } else if (_$9t && iwh != (this._rect.bottom - this._rect.top)) {
        _$e7 = iwh - (this._rect.bottom - this._rect.top);
        if (this.m$N._patternPositionType == EnumPatternPositionType.Bottom) this._rect.top -= _$e7;
        this._rect.bottom = this._rect.top + iwh;
    }
    return _$e7;
};
...
WidgetDockPanelState.prototype._$2t = function (_$8j, _$dS, _$mI) {
    ...
    for (i = _$dS; i < _$e1; i++) {
        ...
        for (j = 0; j < _$fi; j++) {
            _$oJ = _$mI._list[j];
            if (m$57._$nQ._$jW < _$oJ._$nQ._$jW) {
                _$mI.insert(m$57, j);
                bin = true;
                break;
            }
...
WidgetDockPanelState.prototype._$5c = function (_$8j, _$cx, _$cw, _$cF, _$mI, _$rJ, _$9t, _$gD, _$g4, _$eX) {
    ...
    for (i = _$cw; i < _$cF; i++) {
        ...
        if (_$9t) {
            szs.y = m$57.size.y;
            if (szs.y < _$eX[0]) szs.y = _$eX[0];
            szs.x = _$fJ;
        } else {
            szs.y = _$fJ;
            szs.x = m$57.size.x;
            if (szs.x < _$eX[0]) szs.x = _$eX[0];
        }
        _$ov._$5x(_$g4, _$dS, szs, _$gD, _$gD - _$dS - _$fJ);
        if (_$9t) {
            if (szs.y > _$eX[0]) _$eX[0] = szs.y;
            _$dS += szs.x;
        } else {
            _$dS += szs.y;
            if (szs.x > _$eX[0]) _$eX[0] = szs.x;
        }
    }
    for (i = _$cw; i < _$cF; i++) {
        m$57 = _$8j._list[i];
...
WidgetDockPanelState.prototype._$6w = function (_$8j, _$rJ, _$dB) {
    ...
    var _$gD;
    if (_$9t) {
        szs.y = this._rect.bottom - this._rect.top;
        _$gD = this._rect.right - this._rect.left;
    } else {
        _$gD = this._rect.bottom - this._rect.top;
        szs.x = this._rect.right - this._rect.left;
    }
    var _$eM = 0;
    var _$eP = 0;
    var _$go = 0;
    ...
    if (_$go > 1) {
        if (_$rJ < 0) {
            for (j = 0; j < _$go - 1; j++) {
                ...
                for (i = _$gw; i < _$e1; i++) {
                    if (_$9t) {
                        szs.y = this._$ke[j];
                    } else szs.x = this._$ke[j];
                    m$57 = _$8j._list[i];
                    if (m$57._$go == j) {
                        _$ov = m$57._$nQ;
                        if (_$9t) szs.x = m$57._$du; else szs.y = m$57._$du;
                        _$ov._$5x(_$g4, _$dS, szs, _$gD, _$gD - _$dS - m$57._$du);
                        if (_$9t) {
                            if (_$eJ < szs.y) _$eJ = szs.y;
                            _$dS += szs.x;
                        } else {
                            if (_$eJ < szs.x) _$eJ = szs.x;
                            _$dS += szs.y;
                        }
                        this._$ke[j] = _$eJ;
                    } else {
        ...
        for (i = _$gw; i < _$e1; i++) {
            m$57 = _$8j._list[i];
            if (_$9t) {
                m$57.size.x = m$57._$du;
            } else {
                m$57.size.y = m$57._$du;
            }
            _$eP += m$57._$du;
        }
        if (_$9t) {
            _$rJ = (_rect.right - _rect.left - _$eP);
        } else {
            _$rJ = (_rect.bottom - _rect.top - _$eP);
        }
        _$mI.reset();
        ...
        for (j = 0; j < _$e1; j++) {
            ...
            _$ov = m$57._$nQ;
            _$ov.getRect(_$q7);
            m$57.size.x = _$q7.right - _$q7.left;
            m$57.size.y = _$q7.bottom - _$q7.top;
            if (_$9t) {
                m$57._$du = _$q7.right - _$q7.left;
            } else {
                m$57._$du = _$q7.bottom - _$q7.top;
            }
        }
    }
    for (i = 0; i < _$go - 1; i++) {
...
WidgetDockPanelState.prototype._$04 = function (_$9t, _$8j, _$8i, _$dL, _$dF, _$dG) {
    ...
    for (i = 0; i < _$e1; i++) {
        ...
        if (_$9t && (_$q7.right > (_rect.right - _rect.left))) {
            _$dF[0] = i;
            _$dG[0] = _$q7.left;
            break;
        } else if (!_$9t && (_$q7.bottom > (_rect.bottom - _rect.top))) {
            _$dF[0] = i;
            _$dG[0] = _$q7.top;
            break;
        }
...
WidgetDockPanelState.prototype._$g = function (_$8h, _$cP, _$8c, pt) {
    ...
    var _$dT, _$dz;
    if (_$8c) {
        if ((_$oL + _$dx) < (this._rect.right - this._rect.left)) {
            _$oL = this._rect.right - this._rect.left - _$dx;
        }
        if ((_$oM + _$dy) > (this._rect.right - this._rect.left)) _$oM = this._rect.right - this._rect.left - _$dy;
        if (_$pH.x < _$oL) _$pH.x = _$oL;
        if (_$pH.x > _$oM) _$pH.x = _$oM;
        _$dO = _$pH.x - _$dP;
        _$dv = this._rect.right - this._rect.left - _$pH.x - _$dw;
        if (_$pH.x == _$qk.left) _$8f = false;
        _$dT = _$pH.x;
        _$dz = this._rect.right - this._rect.left;
    } else {
        if ((_$oL + _$dx) < (this._rect.bottom - this._rect.top)) {
            _$oL = this._rect.bottom - this._rect.top - _$dx;
        }
        if ((_$oM + _$dy) > (this._rect.bottom - this._rect.top)) _$oM = _rect.bottom - _rect.top - _$dy;
        if (_$pH.y < _$oL) _$pH.y = _$oL;
        if (_$pH.y > _$oM) _$pH.y = _$oM;
        _$dO = _$pH.y - _$dP;
        _$dv = this._rect.bottom - this._rect.top - _$pH.y - _$dw;
        if (_$pH.y == _$qk.top) _$8f = false;
        _$dT = _$pH.y;
        _$dz = this._rect.bottom - this._rect.top;
    }
    if (_$8f) {
        var _$eX = new Array(1);
...
WidgetDockPanelState.prototype._$0B = function (floatPanel, _$nq, _$cD) {
    ...
    if (_$cD == EnumPatternPositionType.Left || _$cD == EnumPatternPositionType.Top) {
        ...
        var _$oU = _$nq._m$FParent;
        if (_$oU == null || _$oU._m$F_2 == _$nq) {
            _$nq = null;
        } else {
            if (_$oU._m$F_2._m$F_1 == null && _$oU._m$F_2._m$F_2 == null) {
                _$nq = _$oU._m$F_2;
            } else if (_$oU._m$F_2._m$F_1 != null) {
                _$nq = _$oU._m$F_2._m$F_1;
            }
        }
        this._$c(floatPanel, _$nq);
    }
...
WidgetDockPanelState.prototype._$c = function (floatPanel, _$mR) {
    if (this._m$F._m$F_1 == null && this._m$F._m$F_2 == null && this._m$F._floatPanel == null) {
        this._m$F._floatPanel = floatPanel;
        floatPanel._m$F = this._m$F;
        return;
    }
    var _$nI = new _$F();
    _$nI._floatPanel = floatPanel;
    floatPanel._m$F = _$nI;
    if (_$mR != null) {
        var _$pm = new _$F();
        if (_$mR._m$FParent == null) {
            _$pm._floatPanel = _$mR._floatPanel;
            _$pm._$8y = _$mR._$8y;
            if (_$mR._floatPanel._m$F == _$mR) {
                _$mR._floatPanel._m$F = _$pm;
            }
            if (_$mR._floatPanel._$l6 == _$mR) {
                _$mR._floatPanel._$l6 = _$pm;
            }
            _$mR._m$F_1 = _$nI;
            _$nI._m$FParent = _$mR;
            _$mR._m$F_2 = _$pm;
            _$pm._m$FParent = _$mR;
            _$mR._floatPanel = null;
        } else {
            var _$oH = _$pm;
            if (_$mR._m$FParent._m$F_2 == _$mR) {
                _$oH._m$FParent = _$mR._m$FParent;
                _$mR._m$FParent._m$F_2 = _$oH;
                _$oH._m$F_2 = _$mR;
                _$mR._m$FParent = _$oH;
                _$oH._m$F_1 = _$nI;
                _$nI._m$FParent = _$oH;
            } else {
                var _$oI;
                _$oI = _$mR._m$FParent._m$F_2;
                _$oH._m$FParent = _$mR._m$FParent;
                _$mR._m$FParent._m$F_2 = _$oH;
                _$oH._m$F_2 = _$oI;
                _$oI._m$FParent = _$oH;
                _$oH._m$F_1 = _$mR;
                _$mR._m$FParent = _$oH;
                _$oH._m$FParent._m$F_1 = _$nI;
                _$nI._m$FParent = _$oH._m$FParent;
            }
        }
    } else {
        var _$o8 = this._m$F;
        while (_$o8._m$F_2 != null) {
            _$o8 = _$o8._m$F_2;
        }
        var _$op = new _$F();
        ...
        if (_$o8._floatPanel != null) {
            if (_$o8._floatPanel._m$F == _$o8) {
                _$o8._floatPanel._m$F = _$op;
            }
        ...
        _$o8._m$F_1 = _$op;
        _$op._m$FParent = _$o8;
        _$o8._m$F_2 = _$nI;
        _$nI._m$FParent = _$o8;
    }
};

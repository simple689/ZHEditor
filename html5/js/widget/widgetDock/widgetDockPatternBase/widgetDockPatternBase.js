...
WidgetDockPatternBase.prototype._$4a = function (_$mS, floatPanel) {
    ...
    if (_$mS._$57List != null) {
        var _$e1 = _$mS._$57List.length;
        for (var i = 0; i < _$e1; i++) {
            var m$57 = _$mS._$57List.get(i);
        ...
        if (_$mS._floatPanel == floatPanel && floatPanel != null) {
            ...
            _$mS._$e(floatPanel.getTitleOriginal(), _$aS, floatPanel._point, floatPanel._$lK.x, floatPanel._$lK.y);
            return true;
        }
    }
    return false;
...
WidgetDockPatternBase.prototype._$55 = function (_$mS, floatPanel, _$sg, patternPositionType, _$dg) {
    ...
    if (_$93) {
        if (floatPanel != null && _$sg == null) {
            if (floatPanel._patternPositionType == floatPanel._$lf._$j1 && floatPanel._$jr < floatPanel._$lf._panelIndex && floatPanel._$lf._panelIndex != -1 && floatPanel._$lf._panelIndex != 0xffffffff) {
                floatPanel._$lf._panelIndex -= 1;
            }
        }
        var _$pU;
        this._panelList[patternPositionType]._list[_$dg]._$kI = null;
...
WidgetDockPatternBase.prototype._$6m = function (_$mS, _$cN) {
    ...
    if (_$mS._floatPanel != null) {
        if (_$mS._floatPanel._pattern == this) {
            _$mS._floatPanel._$jr = _$cN;
        } else if (_$mS._floatPanel._$l7 == this) {
            _$mS._floatPanel._$k4 = _$cN;
        }
    }
    _$mS._$6m(_$cN, this);
};
...
WidgetDockPatternBase.prototype._$4m = function (panel, patternPositionType, _$9e, _$7Q, _$d2, _$d0, _$mS, _$83) {
    ...
    if (_$83 && panel != null && (panel instanceof WidgetDockPanelState) && !(panel instanceof WidgetDockPanelStatePanel)) {
        ...
        panel._$qy(_$mS._floatPanel, rcPanel);
        return;
    }
...
WidgetDockPatternBase.prototype._$k = function (_$mV, _$cu) {
    ...
    var _$ey;
    var _$eB;
    var _$9y = _$mV.m$N._patternPositionType;
...
WidgetDockPatternBase.prototype._$4j = function (_$mS, _$ct, _$9c) {
    ...
    if (!_$mS._$8y) {
        _$mS._floatPanel.getRect(rcPanel);
        plt.x = rcPanel.left;
        plt.y = rcPanel.top;
        if (_$mS._floatPanel._patternPositionType == EnumPatternPositionType.Left || _$mS._floatPanel._patternPositionType == EnumPatternPositionType.Right) {
            if (_$mS._floatPanel._patternPositionType == EnumPatternPositionType.Left) {
                plt.x = rcPanel.left + _$ct;
            } else {
                plt.x = rcPanel.left - _$ct;
            }
            ...
            plt.x = rcPanel.left;
            if (_$mS._floatPanel._patternPositionType == EnumPatternPositionType.Top) {
                plt.y = rcPanel.top + _$ct;
            } else {
                plt.y = rcPanel.top - _$ct;
            }
...
WidgetDockPatternBase.prototype._$2K = function (patternPositionType, _$9a) {
    ...
    if (_$9a == WidgetDockPatternBase._$3S) {
        _$ex = rcWindow.right - this._signLenList[2];
    } else if (_$9a == WidgetDockPatternBase._$5k) {
        _$ex = rcWindow.left + this._signLenList[0];
    } else if (_$9a == WidgetDockPatternBase._$6M) {
        _$ex = rcWindow.bottom - this._signLenList[3];
    } else {
        _$ex = rcWindow.top + this._signLenList[1];
    }
    var panel;
    var rc = new WidgetDockRect();
    var panelNum = this._panelList[patternPositionType].getSize();
...
WidgetDockPatternBase.prototype._$1h = function (_$mX, _$nz, _$gK, _$el, _$qe, pt) {
    ...
    if (WidgetDockPatternBase.isInRect(_$qe, pt) && _$mX._$it) {
        ...
        var _$8Q = _$mX._floatPanel._$kA._$3v(pt);
        if (_$8n || _$8Q) {
            ...
            if ((_$mX._floatPanel._$jy != WidgetDockFloatPanel._$0X) || (_$mX._floatPanel._$kA._tabController == null) || (_$mX._floatPanel._$kA._tabController != null && _$mX._floatPanel._$kA._tabController._tabList.length < 2)) {
                _$mX._$j1 = 0xff;
                return true;
            } else {
...
WidgetDockPatternBase.prototype._$R = function (_$mX, floatPanel, pt, _$nz) {
    ...
    rcWindow.left = 0;
    rcWindow.top = 0;
    rcWindow.left += this._signLenList[0];
    rcWindow.right -= this._signLenList[2];
    rcWindow.top += this._signLenList[1];
    rcWindow.bottom -= this._signLenList[3];
    var _$qe = new WidgetDockRect();
    _$qe.setRect(_$mX.m$5g);
    ...
    if (!bme && _$9j != 0xff && ((_$9j + 1) % 2 == 0)) {
        ...
        if (_$o4 != null) {
            ...
            rcWindow.right = _$nz.x;
            rcWindow.bottom = _$nz.y;
            floatPanel._$2w(_$nz, _$gk, rcWindow, false);
        }
...
WidgetDockPatternBase.prototype._$1P = function (floatPanel, title, mainPattern, _$cD, _$dg, _$mS, _$nr) {
    ...
    for (var i = 0; i < 4; i++) {
        var panelNum = this._panelList[i].getSize();
        var panel;
...
WidgetDockPatternBase.prototype._$1J = function (floatPanel, title, _$mS, _$cX, _$nr) {
    ...
    if (_$mS._$sl != null && (title == _$mS._$sl)) return _$mS; else if (_$mS._$57List != null && _$mS._$57List.length > 0) {
        var _$e1 = _$mS._$57List.length;
        for (var i = 0; i < _$e1; i++) {
            var _$rZ = _$mS._$57List[i]._title;
            if (_$rZ != null && (title == _$rZ)) {
                var m$57 = _$mS._$57List[i];
                _$cX[0] = m$57._$aP;
                if (_$nr != null) {
                    _$nr[0] = m$57;
                }
...
WidgetDockPatternBase.prototype.addFixedPanel = function (element, type) {
    ...
    if (type == EnumPatternPositionType.Center) {
        ...
        height = rcWindow.bottom - rcWindow.top - (this._signLenList[1] + this._signLenList[3]);
        left = 0;
    ...
    for (var nn = 0; nn < _$fz; nn++) {
        ...
        for (var i = 0; i < positionNum; i++) {
            ...
            for (var s = patternPositionPanelNumList[i]; s < _$dD[i]; s++) {
                var pbf = this._$1N(_$si, this._panelList[i]._list[s]._$kI);
                if (pbf != null) {
                    _$8G = true;
...
WidgetDockPatternBase.prototype._$1N = function (title, _$mS) {
    ...
    if (_$mS._$sl != null && _$mS._$sl.lastIndexOf(title) == 0) {
        return _$mS;
    } else if (_$mS._$57List != null && _$mS._$57List.length > 0) {
        var _$e1 = _$mS._$57List.length;
        for (var i = 0; i < _$e1; i++) {
            var _$so = _$mS._$57List[i]._title;
...
WidgetDockPatternBase.prototype._$3X = function (layoutController, _$mS) {
    var len = parseInt(layoutController.read());
    for (var i = 0; i < len; i++) {
        var title = layoutController.read();
        ...
        if (this._isMain) {
            ...
            x = parseInt(layoutController.read());
            y = parseInt(layoutController.read());
        }
        _$mS._$e(title, _$aS, pt, x, y);
    }
};

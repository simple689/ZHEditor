function WidgetDockPatternFloatPanelNormal(isMain) {
    WidgetDockPatternFloatPanelNormal.baseConstructor.call(this, isMain);
    this._window = null;
};
WidgetDockPrototype.bind(WidgetDockPatternFloatPanelNormal, WidgetDockPatternFloatPanel);
WidgetDockPatternFloatPanelNormal.prototype.getWindowRect = function (rc) {
    if (this._$he != null) {
...
WidgetDockPatternFloatPanelNormal.prototype.isInFrame = function (x, y) {
...
WidgetDockPatternFloatPanelNormal.prototype.add = function (com) {
...
WidgetDockPatternFloatPanelNormal.prototype._$d = function (com) {
};
WidgetDockPatternFloatPanelNormal.prototype._$5E = function (com) {
    var len = this._$ha.length;
    for (var i = 0; i < len; i++) {
        if (this._$ha[i] == com) {
...
WidgetDockPatternFloatPanelNormal.prototype._$X = function (_$tE) {
    this._$6r(this._$jO + _$tE);
};
WidgetDockPatternFloatPanelNormal.prototype._$6r = function (_$tE) {
    this._$jO = _$tE;
    this._$74();
};
WidgetDockPatternFloatPanelNormal.prototype._$74 = function () {
    if (this._$he != null) {
...
WidgetDockPatternFloatPanelNormal._$0x = function (frame) {
    ...
    patternFloatPanelNormal._size.width = frame.width;
    patternFloatPanelNormal._size.height = frame.height;
    return patternFloatPanelNormal;
};
...
WidgetDockPatternFloatPanelNormal.prototype.getVisible = function () {
    if (this._$he != null && this._$he.style.visibility == "visible") {
        return true;
    }
    return false;
};
WidgetDockPatternFloatPanelNormal.prototype.setVisible = function (sch) {
    WidgetDockElementController.setElementVisible(this._$he, sch);
};
WidgetDockPatternFloatPanelNormal.prototype._$n = function (floatPanel) {
    this._$it = true;
    this._$is = true;
    this._window = floatPanel._window;
    this._window._$ml(this);
    var _$8q = false;
    if (this._$he == null || (this._$he != null && !this.getVisible())) {
        if (this._$kV == null) {
...
WidgetDockPatternFloatPanelNormal.prototype._$6p = function (left, top, width, height) {
...
WidgetDockPatternFloatPanelNormal.prototype._$10 = function () {
...
WidgetDockPatternFloatPanelNormal.prototype._$01 = function () {
    if (this._$it) {
...
WidgetDockPatternFloatPanelNormal.prototype._$53 = function (floatPanel) {
    WidgetDockPatternFloatPanel.prototype._$53.call(this, floatPanel);
};

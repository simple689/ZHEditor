function WidgetDockPatternBase(isMain) {
    if (isMain) {
        this._panelStatePanelList = new Array(4);
    }
    ...
    for (var k = 0; k < 4; k++) {
        this._patternPositionList[k] = new WidgetDockFloatPanelController();
        this._windowPattern[k] = new WidgetDockFloatPanelController();
    ...
    if (_$mS._$l1 != null) {
        ...
        for (var i = 0; i < _$e1; i++) {
            ...
            if (_$ol._floatPanel != null && _$ol._floatPanel == floatPanel) {
                ...
                if (floatPanel._pattern == this) _$ol._$aP |= WidgetDockFloatPanel._$1A;
                ...
                if (floatPanel._pinType != EnumPinType.None) _$ol._$aP |= WidgetDockFloatPanel._$2U;
                return true;
            }
        }
    } else {
...
WidgetDockPatternBase.prototype._$6E = function (_$9f, _$cB, _$cQ, _$d8) {
    ...
    var _$9l = _$9f;
    while (_$e6 != 0) {
        _$e1 = this._patternPositionList[_$9l].getPanelNum();
        for (var j = _$e1 - 1; j >= 0; j--) {
            _$pU = this._patternPositionList[_$9l]._panelTabList[j];
...
WidgetDockPatternBase.prototype._$2F = function (patternPositionType, panelNow) {
    var panelNum = this._patternPositionList[patternPositionType].getPanelNum();
    var panel;
    for (var i = 0; i < panelNum; i++) {
        panel = this._patternPositionList[patternPositionType]._panelTabList[i];
        if (panel == panelNow) {
            return i;
        }
    }
...
WidgetDockPatternBase.prototype._$5H = function (floatPanel, _$ng) {
    ...
    if (this._patternPositionList[floatPanel._patternPositionType].getPanelNum() < 1) return;
    var panel = this._patternPositionList[floatPanel._patternPositionType]._panelTabList[floatPanel._$jr];
...
WidgetDockPatternBase.prototype._$55 = function (_$mS, floatPanel, _$sg, patternPositionType, _$dg) {
    ...
    var _$st = _$mS;
    if (_$st == null) return;
    var _$pj = this._patternPositionList[patternPositionType]._panelTabList[_$dg];
    var _$gs;
    if (floatPanel != null) {
    ...
    if (_$93) {
        ...
        var _$pU;
        this._patternPositionList[patternPositionType]._panelTabList[_$dg]._$kI = null;
        this._patternPositionList[patternPositionType].deletePanel(_$dg);
        for (var i = _$dg; i < this._patternPositionList[patternPositionType].getPanelNum(); i++) {
            _$pU = this._patternPositionList[patternPositionType]._panelTabList[i];
            var pb = _$pU._$kI;
            this._$6m(pb, i);
        }
        var _$oF;
        if (_$dg == 0) {
            ...
            _$oF = this._patternPositionList[patternPositionType]._panelTabList[_$dg - 1];
        }
...
WidgetDockPatternBase.prototype._$2j = function (patternPositionType) {
    ...
    if (panelNum == 0) {
        ...
        return this._patternPositionList[patternPositionType]._panelTabList[panelNum - 1];
    }
};
WidgetDockPatternBase.prototype._$19 = function (_$mS, patternPositionType, _$9e) {
    ...
    if (_$mS._$oV == null) {
        ...
        if (_$9e != 0xffffffff) {
            _$8T = true;
            if (_$9e > 0) {
                _$nm = this._patternPositionList[patternPositionType]._panelTabList[_$9e - 1];
            ...
            _$9e = this._patternPositionList[patternPositionType].getPanelNum();
        }
        panel._$kI = _$mS;
        panel._$ah(this, patternPositionType);
        WidgetDockPatternBase.resetRect(rcPanel);
        this._patternPositionList[patternPositionType]._$4(panel, _$9e);
        this._$6m(_$mS, _$9e);
        var _$pU;
        var i;
        for (i = _$9e + 1; i < this._patternPositionList[patternPositionType].getPanelNum(); i++) {
            _$pU = this._patternPositionList[patternPositionType]._panelTabList[i];
            this._$6m(_$pU._$kI, i);
        }
    } else {
        this._$6m(_$mS, _$9e);
        panel = this._patternPositionList[patternPositionType]._panelTabList[_$9e];
        if (panel._$05()) {
            panel._$ah(this, patternPositionType);
            WidgetDockPatternBase.resetRect(rcPanel);
        } else {
...
WidgetDockPatternBase.prototype._$4m = function (panel, patternPositionType, _$9e, _$7Q, _$d2, _$d0, _$mS, _$83) {
    ...
    if (_$83 && panel != null && (panel instanceof WidgetDockPanelState) && !(panel instanceof WidgetDockPanelStatePanel)) {
        if ((_$9e - 1) >= 0) {
            _$oB = this._patternPositionList[patternPositionType]._panelTabList[_$9e - 1];
        }
...
WidgetDockPatternBase.prototype._$6O = function (floatPanel) {
    ...
    floatPanel._$jr = this._patternPositionList[_$gl].getPanelNum();
    panel._$kI = _$o6;
    this._patternPositionList[_$gl]._$4(panel, floatPanel._$jr);
    var _$pU;
    var i;
    for (i = floatPanel._$jr + 1; i < this._patternPositionList[_$gl].getPanelNum(); i++) {
        _$pU = this._patternPositionList[_$gl]._panelTabList[i];
        _$6m(_$pU._$kI, i);
    }
};
    ...
    if (floatPanel._$kA == null) {
        ...
        if (floatPanel._$jr != 0xffffffff) {
            ...
            if (floatPanel._$jr > 0) {
                _$nm = this._patternPositionList[_$gl]._panelTabList[floatPanel._$jr - 1];
                panel._$kR = _$nm._$kR;
                panel._$l8 = _$nm._$l8;
            } else {
                panel._$kR = null;
        ...
        panel = this._patternPositionList[_$gl]._panelTabList[floatPanel._$jr];
        if (panel._$05()) {
            panel._$ah(this, floatPanel._patternPositionType);
            WidgetDockPatternBase.resetRect(rcPanel);
        } else {
...
WidgetDockPatternBase.prototype._$W = function (patternPositionType, panelNow, _$nm, _$81) {
    for (var i = 0; i < this._patternPositionList[patternPositionType].getPanelNum(); i++) {
        var _$pU = this._patternPositionList[patternPositionType]._panelTabList[i];
...
WidgetDockPatternBase.prototype._$R = function (_$mX, _$mU, pt, _$nz) {
    ...
    if (!bme && _$9j != 0xff && ((_$9j + 1) % 2 == 0)) {
        _$mX._$j1 = parseInt((_$9j / 2));
        if (_$o4 != null) {
            _$mU._$2G(_$nz, _$gk, rcWindow, true);
        } else {
            ...
            if ((((_$9z + 1) % 2) == 0 && _$9z != 0xff) || _$fZ[0] >= 1) {
                if (_$fZ[0] == 0 || _$fZ[0] == 1) {
                    ...
                    for (var j = i + 1; j < panelNum; j++) {
                        var _$oG = this._patternPositionList[patternPositionType]._panelTabList[j];
                        if (_$oG._$iX) {
                            panel = _$oG;
                            _$8G = true;
                            break;
...
WidgetDockPatternBase.prototype._$1P = function (floatPanel, title, mainPattern, _$cD, _$dg, _$mS, _$nr) {
    ...
    for (var i = 0; i < 4; i++) {
        var panelNum = this._patternPositionList[i].getPanelNum();
        var panel;
        for (var j = 0; j < panelNum; j++) {
            panel = this._patternPositionList[i]._panelTabList[j];
...
WidgetDockPatternBase.prototype._$sa = function (floatPanel, pt) {
    return floatPanel._$sa(pt);
};
...
WidgetDockPatternBase.prototype._$41 = function (layoutController) {
    ...
    for (var i = 0; i < _$gh; i++) {
        ...
        while (true) {
            ...
            if (readStr == secIndexStr) {
                var _$pg = new _$M();
                _$pg._$g6 = 0;
                this._windowPattern[i]._$4(_$pg, _secIndex);
    ...
    for (var i = 0; i < _$gh; i++) {
        var _$ee = this._patternPositionList[i].getPanelNum();
        var _$gl;
        var _$8S;
        if (i == 0 || i == 2) {
            _$gl = 1;
        ...
        if (this._isMain) {
            for (var j = 0; j < 2; j++) {
                var _$fH = this._windowPattern[_$gl + 2 * j].getPanelNum();
                for (var k = 0; k < _$fH; k++) {
                    _$pf = this._windowPattern[_$gl + 2 * j]._panelTabList[k];
                    if (_$8S) {
    ...
    for (var i = 0; i < _$gh; i++) {
        var _$e1 = this._windowPattern[i].getPanelNum();
        var _$e3 = this._patternPositionList[i].getPanelNum();
        for (var j = 0; j < _$e1; j++) {
            var _$pf = this._windowPattern[i]._panelTabList[j];
            _$pf._$eq = _$e3;
            var panel = null;
            if (_$pf._$g6 == 0) {
                panel = new WidgetDockPanel();
            ...
            this._patternPositionList[i]._$4(panel, _$e3);
            _$e3++;
        }
    }
    for (var i = 0; i < _$gh; i++) {
        ...
        if (this._isMain) {
            for (var j = 0; j < _$e1; j++) {
                var _$pf = this._windowPattern[i]._panelTabList[j];
                if (_$pf._$eF != -1) {
                    _$pf._$o2._$kR = _$ou._panelTabList[_$pf._$eF];
                } else {
                    _$pf._$o2._$kR = null;
                }
                if (_$pf._$fB != -1) {
                    _$pf._$o2._$l8 = _$p6._panelTabList[_$pf._$fB];
                } else {
                    _$pf._$o2._$l8 = null;
                }
            }
...
WidgetDockPatternBase.prototype._$0b = function (patternPositionPanelNumList, positionNum, floatPanelController) {
    ...
    for (var i = 0; i < positionNum; i++) {
        _$dD[i] = this._patternPositionList[i].getPanelNum();
    }
    ...
    for (var nn = 0; nn < _$fz; nn++) {
        ...
        for (var i = 0; i < positionNum; i++) {
            ...
            for (var s = patternPositionPanelNumList[i]; s < _$dD[i]; s++) {
                var pbf = this._$1N(_$si, this._patternPositionList[i]._panelTabList[s]._$kI);
                if (pbf != null) {
                    _$8G = true;
...
WidgetDockPatternBase.prototype._$78 = function (_$cD, _$cZ, _$81, _$84) {
    ...
    var _$e1 = _$py._floatPanelController.getPanelNum();
    ...
    var _$pt, _$oz;
    while (_$eq < _$e1) {
        var _$pf = _$py._floatPanelController._panelTabList[_$eq];
        ...
        if ((_$pt) != _$eZ) {
            var _$ei = (_$pt) - _$eZ;
            for (var s = 0; s < _$ei; s++) {
                var _$oA = _$oC._floatPanelController._panelTabList[_$eZ + 1 + s];
            ...
            if ((_$eZ + 1) < _$eY) {
                var _$oA = _$oC._floatPanelController._panelTabList[_$eZ + 1];
                if (_$84) _$oz = _$oA._$eF; else _$oz = _$oA._$fB;
                ...
                var _$ei = (_$oz) - _$eq;
                for (var s = 0; s < _$ei; s++) {
                    var panel = _$py._floatPanelController._panelTabList[_$eq + 1 + s];
                    if (_$81) {
                        panel._$eF = _$eZ;
                    } else {
                        panel._$fB = _$eZ;
    ...
    for (var i = (_$eZ + 1); i < (_$eY - _$eZ - 1); i++) {
        var _$oA = _$oC._floatPanelController._panelTabList[i];
        if (_$84) {
            _$oA._$eF = _$eq - 1;
        } else {
            _$oA._$fB = _$eq - 1;
...
WidgetDockPatternBase.prototype._$8 = function (patternPositionType, floatPanel) {
    ...
    if (this._panelStatePanelList[patternPositionType] != null) {
        _$g1 = this._$2F(patternPositionType, this._panelStatePanelList[patternPositionType]);
        if (this._panelStatePanelList[patternPositionType]._$iX == false) {
            this._$9(patternPositionType, _$g1, _$g7);
        }
    } else {
        this._$9(patternPositionType, _$g1, _$g7);
    }
    this._panelStatePanelList[patternPositionType]._$8(floatPanel);
};
WidgetDockPatternBase.prototype._$j = function (patternPositionType) {
    var panel = this._panelStatePanelList[patternPositionType];
    ...
    var i;
    for (i = 0; i < ino; i++) {
        this._$8(patternPositionType, _$oU[i].floatPanel);
    }
};
WidgetDockPatternBase.prototype._$5M = function (patternPositionType, floatPanel) {
    var panel = this._panelStatePanelList[patternPositionType];
    if (panel == null) return;
    var ino = this._panelStatePanelList[patternPositionType]._$5M(floatPanel);
    if (ino > 0) return;
    if (panel._$iX) {
        var rcPanel = new WidgetDockRect();
    ...
    var _$pU;
    var _$pj = this._panelStatePanelList[patternPositionType];
    this._panelStatePanelList[patternPositionType] = null;
    this._patternPositionList[patternPositionType].deletePanel(_$g1);
    for (var i = _$g1; i < this._patternPositionList[patternPositionType].getPanelNum(); i++) {
        _$pU = this._patternPositionList[patternPositionType]._panelTabList[i];
        var pb = _$pU._$kI;
        this._$6m(pb, i);
    }
    ...
    if (_$g1 == 0) {
        ...
        _$oF = this._patternPositionList[patternPositionType]._panelTabList[_$g1 - 1];
    }
    if (patternPositionType == EnumPatternPositionType.Left || patternPositionType == EnumPatternPositionType.Right) {
        this._$5L(EnumPatternPositionType.Top, _$pj, _$oF);
        this._$5L(EnumPatternPositionType.Bottom, _$pj, _$oF);
...
WidgetDockPatternBase.prototype._$9 = function (patternPositionType, _$dg, iWH) {
    ...
    if (this._panelStatePanelList[patternPositionType] == null) {
        ...
        this._panelStatePanelList[patternPositionType] = panel;
        _$8X = true;
    }
    if (_$8X) {
        if (_$dg != 0xffffffff) {
            _$8T = true;
            if (_$dg > 0) {
                _$nm = this._patternPositionList[patternPositionType]._panelTabList[_$dg - 1];
                panel._$kR = _$nm._$kR;
                panel._$l8 = _$nm._$l8;
            } else {
                panel._$kR = null;
            ...
            _$dg = this._patternPositionList[patternPositionType].getPanelNum();
        }
        panel._$kI = null;
        panel._$ah(this, patternPositionType);
        this._patternPositionList[patternPositionType]._$4(panel, _$dg);
        var _$pU;
        for (var i = _$dg + 1; i < this._patternPositionList[patternPositionType].getPanelNum(); i++) {
            _$pU = this._patternPositionList[patternPositionType]._panelTabList[i];
            this._$6m(_$pU._$kI, i);
        }
    } else {
        panel = this._panelStatePanelList[patternPositionType];
        panel._$ah(this, patternPositionType);
    }
    if (_$8T) {
        if (patternPositionType == EnumPatternPositionType.Bottom) {
...
WidgetDockPatternBase.prototype._$5A = function () {
    for (var i = 0; i < 4; i++) {
        if (this._panelStatePanelList[i] != null) {
            this._panelStatePanelList[i]._$5A();
        }
    }
};
...
WidgetDockPatternBase.prototype._$6t = function (floatPanel) {
    if (floatPanel._$kj > WidgetDockFloatPanel._$q) this._panelStatePanelList[floatPanel._patternPositionType]._$5b(floatPanel); else {
        this._panelStatePanelList[floatPanel._$kj]._$5b(floatPanel);
    }
};
WidgetDockPatternBase.prototype._$0f = function (_$nF, _$nU, _$nz) {
    ...
    if (_$nF._$ka > 0 && _$nF._$ka != 0xffffffff) {
        _$nm = this._patternPositionList[_$nU[0]]._panelTabList[_$nF._$ka - 1];
        _$ot = _$nm._$kR;
        _$p5 = _$nm._$l8;
    }
    var _$oY;
    ...
    if ((_$nU[0] == EnumPatternPositionType.Top) || (_$nU[0] == EnumPatternPositionType.Bottom)) {
        _$oY = this._panelStatePanelList[EnumPatternPositionType.Left];
        _$oZ = this._panelStatePanelList[EnumPatternPositionType.Right];
        _$eH = EnumPatternPositionType.Left;
        _$fD = EnumPatternPositionType.Right;
    } else {
        _$oY = this._panelStatePanelList[EnumPatternPositionType.Top];
        _$oZ = this._panelStatePanelList[EnumPatternPositionType.Bottom];
    ...
    var _$fs;
    if (this._panelStatePanelList[_$nU[0]] == null) {
        _$fs = -2;
    } else {
        _$fs = this._$2F(_$nU[0], this._panelStatePanelList[_$nU[0]]);
    }
    var _$f0 = _$nF._$ka;
    if (_$f0 == 0xFFFFFFFF) {
        _$f0 = 0xFFFF;

...
_$F.prototype._$5w = function (mainPattern, patternPositionType) {
    ...
    if (this._$pr != null && !this._$pr._$8y) {
        ...
        if (this._$o5 != null && this._$o5._tabList.length > 1) {
            ...
            var i;
            for (i = 0; i < _$e1; i++) {
                var _$nQ = this._$o5._tabList[i]._floatPanel;
                var _$ol = new _$57();
...
_$F.prototype._$5J = function (_$mS) {
    ...
    if (_$mS != null) {
        ...
        if (_$mS._$pr != null && !_$mS._$pr._$8y) {
            ...
            this._$br = _$mS._$br;
            this._$8y = _$mS._$8y;
            if (_$mS._$o5 != null && _$mS._$o5._tabList.length > 1) {
                this._$o5 = _$mS._$o5;
                this._$o5._$kE = this;
            }
        }
...
_$F.prototype._$3F = function (_$nf, _$9f, _$7V, _$n1) {
    ...
    _$oc._$of = this._$of;
    if (this._$of != null) {
        if (this._$of._$kA == this) {
            this._$of._$kA = _$oc;
        } else if (this._$of._$l6 == this) {
            this._$of._$l6 = _$oc;
        }
    }
    _$oc._$br = this._$br;
...
_$F.prototype._$31 = function (floatPanel, pt) {
    if (this._$o5 != null && this._$o5._tabList.length >= 2) {
        return this._$o5._$0d(floatPanel, pt);
    }
    return false;
};
...
_$F.prototype._$2 = function (floatPanel) {
    ...
    if (this._$o5 == null || (this._$o5._tabList.length == 0)) {
        this._$o5 = new _$G();
        this._$o5._$kE = this;
        if ((_$fy <= _$eq) || (_$eq < 0)) {
            this._$o5.Add(_$p1);
        ...
        if (_$eq >= 0) {
            ...
            this._$o5.Add(floatPanel);
            this._$o5._$jh = this._$o5._tabList.length - 1;
        }
        floatPanel._$5(this._$o5);
    }
    if (this._$l1 == null) {
...
_$F.prototype._$1M = function (floatPanel) {
    ...
    for (var i = 0; i < _$gi; i++) {
        ...
        if (tmp != null) {
            ...
            if (tmp == floatPanel) {
                if ((this._$o5 == null) || (this._$o5._tabList.length == 0)) return i; else return _$e5;
            }
        }
    }
    return -1;

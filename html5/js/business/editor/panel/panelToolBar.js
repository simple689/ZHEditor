...
PanelToolBar.prototype.init = function (elementRootID) {
    ...
    WidgetHtml.addInput(elementRoot, jsonObjCtrl, WidgetHtml._enumInputType._buttonMenu);
    ...
    WidgetHtml.addInput(elementRoot, jsonObjCtrl, WidgetHtml._enumInputType._button);
